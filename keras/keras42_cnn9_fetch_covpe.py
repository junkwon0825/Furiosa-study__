...
#2.model
model = Sequential()
model.add(Conv2D(64,(3,2),input_shape=(9, 6, 1), activation='relu', padding='same')) #(26,26,64)
model.add(Conv2D(filters=32, kernel_size=(3,2), activation='relu', padding='same'))
# model.add(MaxPooling2D(pool_size=(2,2)))
model.add(Dropout(0.5))
model.add(Conv2D(30,(2,1),activation='relu', padding='same')) #(20,20,16)
model.add(Conv2D(30,(3,2),activation='relu', padding='same')) #(20,20,16)
model.add(Conv2D(30,(3,2),activation='relu', padding='same')) #(21,21,16)
