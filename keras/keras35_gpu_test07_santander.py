...
dense1 = Dense(800, activation='relu')(input1)
drop1 = Dropout(0.3)(dense1)
dense2 = Dense(600, activation='relu')(drop1)
dense3 = Dense(400)(dense2)
drop2 = Dropout(0.2)(dense3)
dense4 = Dense(200, activation='relu')(drop2)
dense5 = Dense(100)(dense4)
drop3 = Dropout(0.1)(dense5)
dense6 = Dense(50, activation='relu')(drop3)
...
# filepath = "".join([path, "k36_", date, filename]) #문자없이 빈공간. + join 뒤에 붙힌다. + 
...
batch_size=40
history = model.fit(x_train,y_train, epochs=500, batch_size = 9000,
                    callbacks=[es,],
