...
model.add(Conv2D(64, (3,3), input_shape=(32,32,3),activation='relu', padding='same', strides=1))
...
es = EarlyStopping(
    ...
    patience=100,                 # 10 epoch 동안 개선 없으면 중단
    restore_best_weights=True,   # 가장 좋았던 weight로 복구
    verbose=1
)
start_time = time.time()
model.fit(x_train ,y_train, epochs=1000, batch_size=2000,
