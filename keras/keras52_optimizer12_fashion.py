...
randidx = np.random.choice(x_train.shape[0], size=augment_size) # 6만개 중에 4만개 랜덤뽑가
...
x_augmented = x_augmented.reshape(x_augmented.shape[0],
                                  x_augmented.shape[1],
                                  x_augmented.shape[2],1)  #(40000, 28, 28, 1)
...
# acc :  0.8443999886512756
# 걸린시간 :  203.41 초

# loss :  0.2868001163005829
# acc :  0.8992999792098999
