...
print(x_test.shape,x_train.shape,y_test.shape,y_train.shape) #(102, 13) (404, 13) (102,) (404,)
x_train = x_train.reshape(-1, 13, 1, 1)
x_test  = x_test.reshape(-1, 13, 1, 1)
#2.model
model = Sequential()
model.add(Conv2D(64,(1,1),input_shape=(13, 1, 1), activation='relu', padding='same')) #(26,26,64)
model.add(Conv2D(filters=32, kernel_size=(1,1), activation='relu', padding='same'))
# model.add(MaxPooling2D(pool_size=(2,2)))
model.add(Dropout(0.5))
model.add(Conv2D(30,(1,1),activation='relu', padding='same')) #(20,20,16)
model.add(Conv2D(30,(1,1),activation='relu', padding='same')) #(20,20,16)
model.add(Conv2D(30,(1,1),activation='relu', padding='same')) #(21,21,16)
